...
import { Command, Github, Menu, Moon, Sun, X, Zap } from "lucide-react"
      ...
      <div className="container mx-auto max-w-screen-2xl px-4">
        <div className="flex h-14 items-center justify-between">
          ...
          <div className="flex items-center gap-1">
            {/* Search hint */}
            <button className="mr-2 hidden h-8 items-center gap-2 rounded-md border border-border bg-muted/50 px-3 text-sm text-muted-foreground transition-colors hover:bg-muted md:flex">
