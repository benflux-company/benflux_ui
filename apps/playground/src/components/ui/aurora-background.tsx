...
export function AuroraBackground({
  ...
  const defaultColors = colors ?? ["#6675f6", "#8b5cf6", "#3b82f6", "#06b6d4", "#10b981"]

  const gradientColors = defaultColors.join(", ")

  return (
    <div
      className={cn("relative flex min-h-screen flex-col bg-zinc-950 text-white", className)}
      {...props}
    >
