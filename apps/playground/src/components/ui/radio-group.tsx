...
>(({ className, label, description, id, ...props }, ref) => {
  ...
  const radio = (
    <RadioGroupPrimitive.Item
      ...
      id={itemId}
      className={cn(
        "border-primary text-primary aspect-square h-4 w-4 rounded-full border shadow",
  ...
  return (
    <div className="flex items-start gap-2">
      ...
      <div className="grid gap-0.5">
        <label htmlFor={itemId} className="cursor-pointer text-sm font-medium leading-none">
          {label}
        </label>
